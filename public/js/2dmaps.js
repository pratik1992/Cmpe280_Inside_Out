  ...
  var defaultOptions = {
    ...
    geographyConfig: {
        ...
        popupTemplate: function(geography, data) {
          return '<div class="hoverinfo" style="color: #000;"><strong>' + geography.properties.name + '</strong></div>';
        },
        popupOnHover: true,
    ...
    bubblesConfig: {
        ...
        textOnBubble: function(geography, data) {
  ...
  function handleBubbles (layer, data, options ) {
    ...
    bubbles
      .enter()
        ...
        .attr('r', 0) //for animation purpose
        .attr('data-info', function(d) {
    ...
    // MyCode added for bubble text
    var text = layer.selectAll("text").data(data, JSON.stringify).enter().append("text");
    var textLabels = text
                    ...
                    .attr("api", function(d) { return d.api; })
      ...
      //bubbles.exit(remove());
      //layer.selectAll('text').exit().remove();
    layer.selectAll("text").data(data, JSON.stringify).exit()
    .transition()
    .remove();
